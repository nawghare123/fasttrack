class Nurses_profile_slots_model {
  bool? success;
  String? message;
  Data? data;

  Nurses_profile_slots_model({this.success, this.message, this.data});

  Nurses_profile_slots_model.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.nurse, this.slots});

  Data.fromJson(Map<String, dynamic> json) {
    nurse = json['nurse'] != null ? new Nurse.fromJson(json['nurse']) : null;
    if (json['slots'] != null) {
      slots = <Slots>[];
